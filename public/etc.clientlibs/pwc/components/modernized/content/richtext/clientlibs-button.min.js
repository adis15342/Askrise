...
if(document.body.classList.contains("bu-theme")){$(".text-component a.btn--secondary, .heighlight-text-content a.btn--secondary").filter(function(){return !$(this).is("[pwcbtnrendition]")
}).addClass("btn-cta--secondary")
...
$('a[pwcbtnrendition="PrimaryButton"]').addClass("btn-cta--primary");
$('a[pwcbtnrendition="SecondaryButton"]').addClass("btn-cta--secondary");
